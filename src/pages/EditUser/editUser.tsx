...
import { editUserAction, emptyActiveUser, getUserAction } from "../../redux/slices/users"
...
export const EditUser = () => {
    ...
    useEffect(() => {
        if (id) { dispatch(getUserAction({ userId: id })) };
        return () => {
    ...
    return (
     userState.loading ?  
            ...
            <div className={styles.inputWrapper}>
                ...
                <TextField className={styles.firstField} id="username" label="User Name" variant="outlined" disabled value={user?.username} />

                <TextField className={styles.secondField} id="name" label="Name" variant="outlined" value={user?.name}
